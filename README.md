...
CUDA_VISIBLE_DEVICES=0 nohup python3 basicsr/train.py --opt Options/RetinexMamba_LOL_kc.yml --auto_resume > log_kc.txt 2>&1 &

CUDA_VISIBLE_DEVICES=1 nohup python3 basicsr/train.py --opt Options/RetinexMamba_LOL_rle.yml --auto_resume > log_rle.txt 2>&1 &

CUDA_VISIBLE_DEVICES=1 nohup python3 basicsr/train.py --opt Options/RetinexMamba_LOL_rle_my.yml > log_rle_my.txt 2>&1 &

python3 Enhancement/test_from_dataset.py --opt Options/RetinexMamba_LOL_kc.yml --weights /home/vladimirfrants9/RetinexMamba/experiments/RetinexMamba_LOL_kc/best_psnr_37.78_107000.pth --dataset LOL_v1

python3 Enhancement/test_from_dataset.py --opt Options/RetinexMamba_LOL_rle.yml --weights /home/vladimirfrants9/RetinexMamba/experiments/RetinexMamba_LOL_rle/best_psnr_34.03_132000.pth --dataset LOL_v1

python3 Enhancement/test_from_dataset.py --opt Options/RetinexMamba_LOL_kc_ext.yml --weights /home/vladimirfrants9/RetinexMamba/experiments/RetinexMamba_LOL_kc/best_psnr_37.78_107000.pth --dataset LOL_v1
